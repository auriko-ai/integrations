...
REPO_RAW_BASE="https://raw.githubusercontent.com/auriko-ai/integrations/main"
...
if [ -t 0 ]; then
    ...
    info "  2. Configure Hermes (no interactive terminal detected):"
    info "       hermes config set model.provider auriko"
    info "       hermes config set model.default claude-haiku-4-5-20251001"
    info "       hermes config set model.base_url https://api.auriko.ai/v1"
fi
info "  3. hermes chat"
info ""
